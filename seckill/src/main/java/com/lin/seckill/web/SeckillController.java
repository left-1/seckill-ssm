...
import com.lin.seckill.dto.SeckillResult;
...
public class SeckillController {
	...
	public SeckillResult<SeckillExecution> execute(
		...
		if(userPhone == null){
			...
			return new SeckillResult<SeckillExecution>(false, "请输入手机号码");
		...
		try {
			...
			SeckillExecution execution = 
					new SeckillExecution(seckillId, SeckillStateEnum.REPEATE_KILL);
